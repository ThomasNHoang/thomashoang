...
export function AuthState({ header, description, linkQuestion, linkLabel, linkHref, state }: AuthStateProps) {
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="text-center text-sm text-gray-500">
          ...
          <Link href={linkHref} className="font-semibold leading-6 text-blue-600 hover:text-blue-500">
            {linkLabel}
          </Link>
        </p>
      </div>
